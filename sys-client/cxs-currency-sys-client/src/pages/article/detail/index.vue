<template>
  <div class="site-content clean content" style="transform: none;">
    ...
    <div id="primary" class="content-area" :class="{'width-full' : !slider}">
          ...
          <div class="reward">
            <div class="social-main">
              ...
              <div class="shang-p">
                ...
                <span class="shang-s">
                  <a style="cursor:pointer" @click.stop="rewardHandle()">赏</a>
                </span>
              </div>
              <div class="share-sd">
      ...
      <el-dialog title="打赏" :visible.sync="dialogFormVisible" class="reward-model" :width="$device.windows ? '40%':'300px'">
        <div v-if="rewardInfo">
          ...
          <div class="reward-img" v-if="rewardType === 1 && rewardInfo.weixinBorderColor && rewardInfo.weixinImg">
            <div class="img-boder" :style="{borderColor: rewardInfo.weixinBorderColor}">
              <img :src="baseUrl + rewardInfo.weixinImg"/>
            </div>
            <p class="reward-tip" :style="{color: rewardInfo.weixinBorderColor}">打赏</p>
          </div>
          ...
          <div class="reward-img" v-if="rewardType === 2 && rewardInfo.zhifubaoBorderColor && rewardInfo.zhifubaoImg">
            <div class="img-boder" :style="{borderColor: rewardInfo.zhifubaoBorderColor}">
              <img :src="baseUrl + rewardInfo.zhifubaoImg"/>
            </div>
